...
class OrderServiceClient extends $grpc.Client {
  static final _$getAll = $grpc.ClientMethod<$8.GetAllOrdersRequest, $8.GetAllOrdersResponse>(
      '/gs_protobufs.order.OrderService/GetAll',
      ($8.GetAllOrdersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $8.GetAllOrdersResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$8.GetAllOrdersResponse> getAll($8.GetAllOrdersRequest request, {$grpc.CallOptions? options}) {
...
abstract class OrderServiceBase extends $grpc.Service {
  ...
  OrderServiceBase() {
    $addMethod($grpc.ServiceMethod<$8.GetAllOrdersRequest, $8.GetAllOrdersResponse>(
        'GetAll',
        getAll_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $8.GetAllOrdersRequest.fromBuffer(value),
        ($8.GetAllOrdersResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$8.GetAllOrdersResponse> getAll_Pre($grpc.ServiceCall call, $async.Future<$8.GetAllOrdersRequest> request) async {
  ...
  $async.Future<$8.GetAllOrdersResponse> getAll($grpc.ServiceCall call, $8.GetAllOrdersRequest request);
